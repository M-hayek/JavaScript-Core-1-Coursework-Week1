...
function calculateSalesTax(rawprice) {
...
let finalPrice= calculateSalesTax(10);
...
function addTaxAndFormatCurrency(beforeTaxPrice) {

  let finalPrice = (calculateSalesTax(beforeTaxPrice)).toFixed(2);
  return ("£" + finalPrice);
}


let finalPrice1= addTaxAndFormatCurrency(10);
